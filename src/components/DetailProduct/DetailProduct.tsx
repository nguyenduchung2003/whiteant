                  ...
                  <Typography variant="h5">
                    <strong>
                      {new Intl.NumberFormat("vi-VN", {
                        style: "currency",
                        currency: "VND",
                      }).format(item.price as unknown as number)}
                    </strong>
                  </Typography>
                  <Box className="flex content-center">
                <Typography className="h-[50px]">Chọn màu sắc</Typography>
                <ul className="grid w-[50%] gap-6 md:grid-cols-3 ">
                  <li>
                    <button
                      onClick={() => setSelectedSize('S')}
                      className={`${
                        selectedSize === 'S' ? 'bg-gray-300' : ''
                  ...
                  <Box className="flex content-center">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (item.quantity && quantity < item.quantity) {
                            ...
                            toast.warning("Không được vượt quá số lượng", {
                              position: "top-right",
                              autoClose: 1000,
                    ...
                    <Button className="ml-5 bg-black text-white w-[50%] rounded-full">
                      <AddShoppingCartIcon></AddShoppingCartIcon>Thêm vào giỏ
                      hàng
                    </Button>
                  </Box>
                </Box>
